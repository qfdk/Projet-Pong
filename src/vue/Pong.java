...
public class Pong extends JFrame implements Runnable, MouseListener,
		MouseMotionListener,WindowListener
{
	...
	private String pseudo2="Serveur Inconnu";
	private Image image;
	/*
	 * 初始化程序
	 */
	...
	private void creerConexion()
	{
			try
			{
				//si conn ne peut pas creer donc ,conn est null 
				//on ne peut pas fermer la connexion
...
//		System.out.println("cc->"+start);
	...
	/**
	 * un constructeur avec des params
	 * @param isServeur
	 */
	public Pong(boolean isServeur)
	{
		this.isServeur=isServeur;
		//pour attacher l'evenement closed
		...
		{
			JOptionPane.showMessageDialog(null, "Client:Problem de lire le fichier config","Attention :X",JOptionPane.YES_OPTION,new ImageIcon("img/attention.gif"));
			System.out.println("Client:Problem de lire le fichier config ");
			System.exit(-1);
		}
		catch (IOException e)
		{
